...
//"static block" olusturup bu islemleri static block'un icine yazmak 
//daha iyidir.
//"static block" variable'lara deger atamak icin de kullanilabilir.
	
//"static block" class'in icinde butun method'larin(main dahil) ve
//constructorlarin 
//disinda olusturulmalidir.
	
//static block class olusturuldugu zaman olusturulur.
	
//"static block" tum methodlardan(main method dahil) ve 
//constructorlardan once calistirilir.
...
//Static class olusturulabilir ama alt classlar(inner class) 
//	static class olabilir.
//Ust classlar(outer class) static olamazlar.
	
	static class AltClass{  
//--> alt class oluşturduk.en üstteki class ın içinde.
