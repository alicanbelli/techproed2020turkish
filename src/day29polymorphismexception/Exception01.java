...
// Tabii ki; 1)FileNotFoundException
//		==> Dosya bulunamadigi zaman ortaya cikar
//           2)IOException(Input Output Exception)
//		==>Input veya Output yapilirken olusan problemlerde ortaya cikar.
// Not: FileNotFoundException, IOException'in child'idir.
// Not: Compile Time Exception'lar mutlaka Handle edilmelidir 
//		(Halledilmelidir)
// Checked Exception'lar iki turlu handle edilir:
// 1) Method isminden sonra "throws" keyword kullanilir
// 2) try-catch block kullanilir. try-catch block kullanmak daha iyidir; 
//		cunku readable'dir.
	}
}